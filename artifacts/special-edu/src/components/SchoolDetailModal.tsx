...
function levelLabel(학교급: string): string {
  return { 유치원: "유치원", 초등학교: "초등", 중학교: "중학교", 고등학교: "고등학교" }[학교급] ?? 학교급;
}
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-4 divide-x divide-border border-b border-border">
          {[
            { label: "특수학급 수", value: school.특수학급수 + "개", sub: null },
            { label: "특수학급 배치", value: school.특수배치 + "명", sub: null },
            { label: "일반학급 배치", value: school.일반배치 + "명", sub: null },
            {
              label: "잔여 자리",
        ...
        {/* Grade breakdown */}
        <div className="p-6">
          <h3 className="text-sm font-semibold text-muted-foreground mb-3">학년별 배치 현황</h3>
          {grades.length === 0 ? (
            ...
            <div className="overflow-auto rounded-lg border border-border">
              <table className="w-full text-sm">
                ...
                <tfoot>
                  <tr className="bg-[#1B4FA8]/5 border-t border-border font-bold">
